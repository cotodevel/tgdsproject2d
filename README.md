...
Project Specific description: TGDS Project + SDL frontend for both WIN32 and NintendoDS. It's meant for 2D applications using the 2D DS hardware 
...
Note: TGDSProject2D offers Custom ARM7 VRAM Core providing all necessary services for wifi + soundstream + homebrew loader 
