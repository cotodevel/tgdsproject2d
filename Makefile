...
#Custom
# Project Specific
export TGDSPROJECTNAME = tgdsproject2d
...
export DIRS_ARM9_SRC = data/	\
			...
			source/TGDSProject-src/src/ \
			source/TGDSProject-src/src/lib/	\
			../common/	\
			../common/templateCode/source/	\
...
$(EXECUTABLE_FNAME)	:	compile
	-@echo 'ndstool begin'
	$(NDSTOOL)	-v	-c $@	-7  $(CURDIR)/common/templateCode/stage1_7/$(BINSTRIP_RULE_7)	-e7  0x02380000	-9 $(CURDIR)/arm9/$(BINSTRIP_RULE_9) -e9  0x02000800	-r9 0x02000000	-g "TGDS" "NN" "NDS.TinyFB"	-b icon.bmp "SNEmulDS $(EXECUTABLE_VERSION_HEADER) ; SNES Emulator for DS; by archeide bubble2k gladius" 
...
ifeq ($(SOURCE_MAKEFILE9),default)
	...
	-@rm -rf	$(DIR_ARM9)/data/arm7bootldr.binlzss	$(DIR_ARM9)/data/arm7bootldr.binlzss
